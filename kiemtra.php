...
<script>
    function validateForm() {
        const totalQuestions = <?= count($questions) ?>;//chèn số lượng câu hỏi từ PHP vào JS.
        for(let i=0; i < totalQuestions; i++) {//Duyệt từng câu hỏi để kiểm tra xem có radio nào được chọn chưa.
            const radios = document.getElementsByName('answer' + i);
            let answered = false;
            for(let r of radios) {
                if(r.checked) {
...
load_footer();
?>
>>>>>>> 19c08f9bc6f67bc193175155be75fc64ac07c020
